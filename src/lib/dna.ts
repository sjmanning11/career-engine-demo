...
REMOTE / LOCATION (15 pts): TIER 1 — 15 pts: Fully remote, no office requirement. TIER 2 — 12 pts: Austin-based or hybrid within 35 miles of Georgetown TX (78626). Cities in range: Austin, Round Rock, Cedar Park, Leander, Georgetown, Pflugerville, Hutto, Taylor, Buda, Kyle, San Marcos. Role must be hybrid or flexible — not 5 days/week in office. TIER 3 — 6 pts: Role with unclear or unstated remote/hybrid policy (including any role that reached this step with LOCATION PRE-CHECK: UNCLEAR). Flag summary with "[Manual review: location policy unclear]". Do NOT score 0 for ambiguity — default to 6. TIER 4 — 0 pts: Requires relocation outside the Austin metro, OR mandates 5-day in-office attendance regardless of location.
